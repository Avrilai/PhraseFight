...
class GfycatData {
  ...
  GfycatData() {
    _animalsList = _animals.split('\n');
    _adjectivesList = _adjectives.split('\n');
  }

  String getRandomMatchId() {
    Random random = new Random();
    String ad1 = _adjectivesList[random.nextInt(_adjectivesList.length)];
    String ad2 = _adjectivesList[random.nextInt(_adjectivesList.length)];
    String animal = _animalsList[random.nextInt(_animalsList.length)];
    return "$ad1-$ad2-$animal";
  }

  static final _animals = '''aardvark
aardwolf
abalone
abyssiniancat
